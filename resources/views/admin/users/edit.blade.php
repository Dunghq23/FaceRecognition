...
@section('content')
    ...
    <x-dashboard-title text="Cập nhật thông tin người dùng" />
    <div class="row g-0 p-3">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body p-3">
                    ...
                    <form id="formInformation" method="POST"
                        action="{{ route('management.users.update', $user->account_id) }}">
                        @csrf
                        @method('PATCH')
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                    id="Name" name="Name" value="{{ $user->employee->employee_name }}" tabindex="1" disabled>
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ $user->username ?? old('UserName') }}" tabindex="2" disabled>
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="form-group">
